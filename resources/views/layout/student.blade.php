...
<head>
    ...
    body {
        /* Strength: Deep Sky Blue to Soft Cerulean */
    ...
    <div class="flex">
        ...
        <div class="fixed left-0 top-0 z-20 bg-white border-r border-emerald-200 pt-16 w-[250px] h-full sidebar-scroll overflow-y-auto transform transition-transform duration-300 ease-in-out shadow-2xl shadow-emerald-900/10"
            ...
            <nav class="p-4 space-y-3 mt-6">
                ...
                {{-- Dashboard --}}
                <a href="#" class="flex items-center p-3 text-sm rounded-xl transition-all duration-200 {{ $routeIs('student.dashboard') }}">
                ...
                {{-- NEW: Assessment --}}
                <a href="#" class="flex items-center p-3 text-sm rounded-xl transition-all duration-200 {{ $routeIs('student.assessment') }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
