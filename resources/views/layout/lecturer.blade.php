    ...
    <div class="flex">
        ...
        <div class="fixed left-0 top-0 z-20 bg-white border-r border-indigo-200 pt-16 w-[250px] h-full sidebar-scroll overflow-y-auto transform transition-transform duration-300 ease-in-out shadow-2xl shadow-indigo-900/20"
            ...
            <nav class="p-4 space-y-3 mt-6">
                ...
                <a href="{{ route('dashboard.lecturer') }}" class="flex items-center p-3 text-sm rounded-xl transition-all duration-200 {{ $routeIs('lecturer.dashboard') }}">
                ...
                <a href="{{ route('lecturer.myCourses') }}" class="flex items-center p-3 text-sm rounded-xl transition-all duration-200 {{ $routeIs('lecturer.courses') }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" class="flex items-center p-3 text-sm rounded-xl transition-all duration-200 {{ $routeIs('lecturer.assessment') }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
